    ...
    e(".filter-active").imagesLoaded(function () {
      ...
      e(".load-more-btn").on("click", function () {
        ...
        setTimeout(function () {
          ...
          0 === a.length &&
            (a = n.closest(".container").find(".load-more-active")),
            a
    ...
    const e = [].slice.call(
      ...
      n = (e, t) => {
        const {
          ...
          o =
            e.pageX - (i + window.pageXOffset) - (a / 2) * (a > n ? n / a : 1),
          r =
            e.pageY - (s + window.pageYOffset) - (n / 2) * (n > a ? a / n : 1);
    ...
    //   }
      update(e, s) {
        this.element.classList.remove(...a),
          this.element.classList.add(`${s}-${t[n(e, this.element)]}`);
      }
    }
    e.forEach((e) => new s(e));
  }
